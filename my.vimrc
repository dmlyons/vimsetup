...
let g:go_metalinter_autosave_enabled = ['govet', 'golint', 'errcheck', 'unused', 'structcheck', 'gosimple', 'ineffassign']
let g:go_metalinter_enabled = ['govet', 'golint', 'errcheck', 'unused', 'structcheck', 'gosimple', 'ineffassign']
